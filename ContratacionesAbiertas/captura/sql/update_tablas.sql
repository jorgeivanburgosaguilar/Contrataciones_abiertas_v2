...
(5,'intermediate','marketStudies','Market Studies','Resultado de la investigación de mercado','','',1),
...
(14,'intermediate','tenderNotice','Tender Notice','Convocatoria o Aviso de adjudicación directa','The formal notice that gives details of a tender. This may be a link to a downloadable document, to a web page or to an official gazette in which the notice is contained.','',2),
...
(21,'intermediate','awardNotice','Award Notice','Notificación de la adjudicación','The formal notice that gives details of the contract award. This may be a link to a downloadable document,to a web page or to an official gazette in which the notice is contained.','',3),
...
(28,'intermediate','contractSigned','Signed Contract','Contrato o pedido','','',4),
...
(34,'intermediate','completionCertificate','Completion certificate','Dictamen de cumplimiento','','',5),
...
(37,'intermediate','request','Request','Requisición','','',1),
(38,'intermediate','unsuccessfulProcedureNotice','Unsuccessful procedure notice','Acta de fallo (desierto) u Oficio declaratorio de procedimiento desierto','','',3);
...
DROP TABLE IF EXISTS gdmx_document cascade;
...
-- roles extra
ALTER TABLE roles ADD COLUMN IF NOT EXISTS requestingunit BOOLEAN;
ALTER TABLE roles ADD COLUMN IF NOT EXISTS contractingunit BOOLEAN;
ALTER TABLE roles ADD COLUMN IF NOT EXISTS technicalunit BOOLEAN;