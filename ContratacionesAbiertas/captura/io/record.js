    ...
    */
    let getExtensions = async function() {
        const extensions = [
            ...
            "https://raw.githubusercontent.com/INAImexico/ocds_exchangeRate_extension/master/extension.json",
            "https://raw.githubusercontent.com/INAImexico/ocds_location_extension/master/extension.json",
            ...
            "https://raw.githubusercontent.com/INAImexico/ocds_memberOf_extension/master/extension.json",
            "https://raw.githubusercontent.com/INAImexico/ocds_additionalContactPoints_extension/master/extension.json",
            "https://raw.githubusercontent.com/INAImexico/ocds_contactPointType_extension/master/extension.json",
            "https://raw.githubusercontent.com/INAImexico/ocds_budget_breakdown_extension/master/extension.json",
            "https://raw.githubusercontent.com/INAImexico/ocds_budgetLines_extension/master/extension.json",
            "https://raw.githubusercontent.com/INAImexico/ocds_guarantees_extension/master/extension.json" 
        ];
    ...
    */
    let generateRecord = async function(host) {
        ...
        if (release == null) {
            ...
            jp.value(release, '$.tender.clarificationMeetings[*].clarificationMeetingAttendees[*].identifier.position', undefined)
            jp.value(release, '$.tender.clarificationMeetings[*].clarificationMeetingOfficials[*].identifier.position', undefined)
    ...
    let generateClarificationMeetings = async function() {
        ...
        return meetings != null ? meetings.map((meeting) => {
            return {
                ...
                date: meeting.date,
                clarificationMeetingAttendees: attenders != null && attenders.filter((x) => x.clarificationmeeting == meeting.id).length > 0 ? 
                    attenders.filter((x) => x.clarificationmeeting == meeting.id).map((x) => { return toOrganizationsReference(x); }) : [],
                clarificationMeetingOfficials: officials != null && officials.filter((x) => x.clarificationmeeting == meeting.id).length > 0 ? 
        ...
        return parties.map((party) => {
            return {
                ...
                identifier: { 
                    ...
                    id: party.identifier_id,
                    legalName: party.identifier_legalname,
                    juridicalPersonhood: party.naturalperson ? 'naturalPerson' : 'legalPerson',
                ...
                contactPoint: {
                    ...
                    contactPointType: party.contactpoint_type,
