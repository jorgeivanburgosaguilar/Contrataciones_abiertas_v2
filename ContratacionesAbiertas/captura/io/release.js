...
function release(db) {
    ...
    let generateParties = async function () {
        ...
        //let additionalIdentifiers = await generateAdditionalIdentifiers();
        ...
        return parties.map(p => clean({
            ...
            identifier: clean({
                ...
                juridicalPersonhood: p.naturalperson ? 'naturalPerson' : 'legalPerson',
            ...
            contactPoint: clean({
                ...
                contactPointType: p.contactpoint_type,
        ...
        roles.map(rol => {
            result[rol.parties_id] = Object.keys(rol).filter(key => rol[key] === true).map(rol => {
                switch (rol) {
                    ...
                    case 'clarificationmeetingattendee': rol = 'clarificationMeetingAttendee'; break;
                    case 'clarificationmeetingofficial': rol = 'clarificationMeetingOfficial'; break;
    ...
    let generateGuarantees = async () => {
        ...
        let gen = async guarantee => clean({
            ...
            date: guarantee.date,
            guaranteedObligations: guarantee.guaranteedobligations,
            value: {
    ...
    let generateClarificationMeetings = async function () {
        ...
        return positions.map(pos => clean({
            ...
            date: pos.date,
            clarificationMeetingAttendees: attenders,
            clarificationMeetingOfficials: officials
        }));
    }
