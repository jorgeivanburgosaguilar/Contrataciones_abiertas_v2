        ...
        $.post('/contratacionesabiertas/stage-chart-data', {
            ...
            function resizeHandler () {
                if (window.innerWidth < 700) {
                    ...
                    chartOptions['axes']['yaxis']['ticks'] = ['Licitación pública', 'Adjudicación directa art.41', 'Adjudicación directa art.42', 'Excepciones al reglamento', 'Invitación a cuando menos tres personas', 'Convenio de colaboración', 'Adhesiones y membresías'];
