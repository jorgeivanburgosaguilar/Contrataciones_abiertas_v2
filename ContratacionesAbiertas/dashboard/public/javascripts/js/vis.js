...
BubbleChart = (function() {
    function BubbleChart(data) {
        ...
        this.data = data;
        this.width = 1300;  //Tamaño del área de los nodos
        this.height = 1000;
        ...
        // TAMAÑO DE LOS NODOS
        this.radius_scale = d3.scale.pow().exponent(0.3).domain([1, num_max_indicadores]).range([1, 110]); //.domain([1, 4.5]).range([10, 30]);
        this.create_nodes();
        this.create_vis();
    ...
    BubbleChart.prototype.create_vis = function() {
        ...
        this.vis = d3.select("#vis").append("svg").attr("id", "svg_vis").attr("preserveAspectRatio", "xMinYMin meet").attr("viewBox", "-350 -300 2600 1600");
